       ...
       /* storageReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("UserProfile/Images/Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                profileName.setText("Diver Name: "+"Kunal Patil");
                profilePhone.setText("Phone: "+"7028991096");
                profileEmail.setText("Email: "+"kunal2307@gmail.com");
                profileAmb.setText("Vehicle No: "+4040);
        ...
        profileUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String driverMsg = "Ambulance Booked from "+"\n To"+hospitalAddr+"\n Contact Details "+"7028991096";
                String sms = "Ambulance Booking Successful..\n Driver Details : "+dname+"\n"+dphone+"\n"+dAmbNo+"- Medbus";
                ...
                try {
                    ...
                    smsManager2.sendTextMessage("7028991096", null, driverMsg, null, null);
                    Toast.makeText(getApplicationContext(), "SMS Sent!",
                            Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(),AnimalAmbulanceBookedActivity.class));
                } catch (Exception e) {
